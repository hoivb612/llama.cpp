...
struct llama_model {
    ...
    // Gemma 4 MTP assistant weights (populated only on the nested gemma4_assistant model)
    ...
    // Nested assistant model loaded via llama_model_load_mtp_from_file (owns the mtp_* tensors above).
