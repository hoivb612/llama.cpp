...
struct llama_cparams {
    ...
    bool embeddings;
    bool embeddings_pre_norm;        // also extract the hidden state before the final output norm (Phi3 fusionOp; no MTP)
    ...
    bool embeddings_nextn;           // also extract the hidden state before the final output norm (upstream NEXTN MTP draft heads)
