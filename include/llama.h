...
#define LLAMA_STATE_SEQ_FLAGS_ON_DEVICE 2
    ...
    // Fork-private APIs (dc/GGML_B612 + GGML_XBOX_PERF). Upstream removed
    // llama_memory_breakdown_print here in PR #22171; the printer now lives
    // in libcommon as common_memory_breakdown_print().
