// mul_mat_vec_q5k_dp4a_nc2.hlsl - Q5_K dp4a matvec for M==2 batch.
//
// NUM_ROWS=2 x NUM_COLS=2 outputs per workgroup. Decodes each Q5_K super-block
// once, reuses decoded weights across both activation columns. Mirrors
// mul_mat_vec_q4k_dp4a_nc2.hlsl structure with Q5_K's 5th-bit qh merge.
...
void main(uint3 group_id : SV_GroupID, uint tid : SV_GroupIndex) {
    ...
    for (uint block_idx = ix; block_idx < num_blocks; block_idx += it_size) {
        ...
        // --- Col 0 ---
        {
            ...
            acc00 += compute_dp4a_row_q5k(dall0, dmin0, sc00, sc01, sc02, sc03, sc04, sc05, sc06, sc07,
                                          q5_lo_0, q5_hi_0, q5_lo64_0, q5_hi64_0,
                                          q8d0, q8d1, q8d2, q8d3,
                                          q8_qs0, q8_qs1, q8_qs2, q8_qs3,
                                          q8_psum0, q8_psum1, q8_psum2, q8_psum3);
            acc10 += compute_dp4a_row_q5k(dall1, dmin1, sc10, sc11, sc12, sc13, sc14, sc15, sc16, sc17,
                                          q5_lo_1, q5_hi_1, q5_lo64_1, q5_hi64_1,
                                          q8d0, q8d1, q8d2, q8d3,
                                          q8_qs0, q8_qs1, q8_qs2, q8_qs3,
                                          q8_psum0, q8_psum1, q8_psum2, q8_psum3);
        ...
        // --- Col 1 ---
        {
            ...
            acc01 += compute_dp4a_row_q5k(dall0, dmin0, sc00, sc01, sc02, sc03, sc04, sc05, sc06, sc07,
                                          q5_lo_0, q5_hi_0, q5_lo64_0, q5_hi64_0,
                                          q8d0, q8d1, q8d2, q8d3,
                                          q8_qs0, q8_qs1, q8_qs2, q8_qs3,
                                          q8_psum0, q8_psum1, q8_psum2, q8_psum3);
            acc11 += compute_dp4a_row_q5k(dall1, dmin1, sc10, sc11, sc12, sc13, sc14, sc15, sc16, sc17,
                                          q5_lo_1, q5_hi_1, q5_lo64_1, q5_hi64_1,
                                          q8d0, q8d1, q8d2, q8d3,
                                          q8_qs0, q8_qs1, q8_qs2, q8_qs3,
                                          q8_psum0, q8_psum1, q8_psum2, q8_psum3);
