// mul_mat_vec_q4k_dp4a_nc4.hlsl - Q4_K dp4a matvec for M==4 batch.
//
// NUM_ROWS=2 x NUM_COLS=4 outputs per workgroup. Same template as nc2:
// decode each Q4_K super-block once, reuse the decoded weights across
// 4 activation columns.
