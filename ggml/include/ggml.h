...
extern "C" {
    ...
    GGML_API void        ggml_fp32_to_fp16_row_cpu(const float *, ggml_fp16_t *, int64_t);
#else
    ...
    GGML_API void        ggml_fp32_to_bf16_row_cpu(const float *, ggml_bf16_t *, int64_t);
#else
    ...
    enum ggml_type {
        ...
        GGML_TYPE_Q4_0_8_8 = 33, // [not used] enabled just for performance tracking post repacking
        GGML_TYPE_TQ1_0   = 34,
        GGML_TYPE_TQ2_0   = 35,
