...
int main(void) {
    ...
    const struct ggml_tensor * src0 = model.a;
    const struct ggml_tensor * src1 = model.b;
    const struct ggml_tensor * dst = result;

    GGML_TENSOR_BINARY_OP_LOCALS

    printf("ne00 %2zd, ne01 %2zd, ne02 %2zd, ne03 %2zd\n"
           "nb00 %2zd, nb01 %2zd, nb02 %2zd, nb03 %2zd\n" 
           "ne10 %2zd, ne11 %2zd, ne12 %2zd, ne13 %2zd\n"
           "nb10 %2zd, nb11 %2zd, nb12 %2zd, nb13 %2zd\n"
           "ne0  %2zd, ne1  %2zd, ne2  %2zd, ne3  %2zd\n"
           "nb0  %2zd, nb1  %2zd, nb2  %2zd, nb3  %2zd\n\n",
           ne00, ne01, ne02, ne03,
           nb00, nb01, nb02, nb03,
           ne10, ne11, ne12, ne13,
           nb10, nb11, nb12, nb13,
    ...
    for (int j = 0; j < result->ne[1] /* rows */; j++) {
        ...
        for (int i = 0; i < result->ne[0] /* cols */; i++) {
            printf(" %5.2f", out_data[j * result->ne[0] + i]);
        }
    }
    printf(" ]\n");
