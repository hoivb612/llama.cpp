...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_Q8_0_x8 = 35,
        GGML_TYPE_Q8_0_Q8_0_x8 = 36,
        GGML_TYPE_Q2_K_x8 = 37,
        GGML_TYPE_Q2_K_Q8_K_x8 = 38,
        GGML_TYPE_Q3_K_x8 = 39,
        GGML_TYPE_Q3_K_Q8_K_x8 = 40,
        GGML_TYPE_Q4_K_x8 = 41,
        GGML_TYPE_Q4_K_Q8_K_x8 = 42,
        GGML_TYPE_Q6_K_x8 = 43,
        GGML_TYPE_Q6_K_Q8_K_x8 = 44,
        GGML_TYPE_Q4_0_x8 = 45,
        GGML_TYPE_Q4_0_Q8_0_x8 = 46,
        GGML_TYPE_COUNT,
    };
...
extern "C" {
    ...
    GGML_API void ggml_vec_mul1_f32(const uint64_t n, float * z, const float * x, const float v);
    GGML_API void ggml_vec_sumsq_f32(const uint64_t n, float * s, const float * x);
    ...
    GGML_API void ggml_repack_tensor_callgraph (struct ggml_cgraph *cgraph);
...
#define GGML_RESTRICT restrict
    ...
    typedef void (*ggml_vec_dot_t)   (const int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT x, size_t bx,
